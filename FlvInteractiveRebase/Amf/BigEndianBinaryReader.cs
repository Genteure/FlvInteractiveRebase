...
namespace FlvInteractiveRebase.Amf
{
    ...
    public class BigEndianBinaryReader : BinaryReader
    {
        ...
        /// <inheritdoc/>
        public override int Read(Span<char> buffer) => base.Read(buffer);
        ...
        /// <inheritdoc/>
        public override decimal ReadDecimal() => BitConverter.IsLittleEndian ? throw new Exception("not supported") : base.ReadDecimal();
        ...
        public override float ReadSingle() => BitConverter.IsLittleEndian
                ? BitConverter.Int32BitsToSingle(BinaryPrimitives.ReadInt32BigEndian(base.ReadBytes(sizeof(float))))
                : base.ReadSingle();
